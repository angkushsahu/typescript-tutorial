...
function acceptNumberButReturnString(num: number): string {
	return "hello world";
}
...
const returnStringOrBoolean = (num: number): boolean | string =>
	num > 5 ? true : "not greater than 5";

const returnStringOrBooleanReturnValue = returnStringOrBoolean(4);
console.log(returnStringOrBooleanReturnValue);

const consoleLog = (num: number): void => console.log(num);
consoleLog(19);
